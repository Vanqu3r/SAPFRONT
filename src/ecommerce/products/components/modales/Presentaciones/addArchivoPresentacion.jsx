...
import { addOneArchivo } from "../../../services/remote/post/Presentaciones/AddOneProduct"; // Revisa si esta ruta es correcta

const AddArchivoPresentacion = ({ open, onClose, selectedRowData, IdProductSelect, selectedId }) => {
    const [mensajeErrorAlert, setMensajeErrorAlert] = useState("");
    const [mensajeExitoAlert, setMensajeExitoAlert] = useState("");
    const [loading, setLoading] = useState(false);
    const [barcodeValue, setBarcodeValue] = useState(selectedRowData?.CodigoBarras || "000000000000");
    ...
    const formik = useFormik({
        initialValues: {
            IdArchivoBK: selectedRowData?.IdArchivoBK || genID().substring(0,8),
            IdArchivoOK: selectedRowData?.IdArchivoOK || genID().substring(0,8),
            ...
            Path: selectedRowData?.Path || "/path:///",
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const result = await addOneArchivo(IdProductSelect, selectedId, {
                    ...values,
                });
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth>
            <form onSubmit={formik.handleSubmit}>
                <DialogTitle>
                    <Typography variant="h6">Agregar Archivo</Typography>
                </DialogTitle>
                <DialogContent>
                    <TextField
                        id="IdArchivoBK"
...
export default AddArchivoPresentacion;
