...
import { putPaquete } from "../../../services/remote/put/presentaciones/putpresentaciones";

const Putpaquete = ({ open, onClose, selectedRowData, IdProductSelect, selectedId, idChin }) => {
    ...
    const formik = useFormik({
        initialValues: {
            IdPresentaOK: selectedRowData?.IdPresentaOK || "",
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                const result = await putPaquete(IdProductSelect, selectedId, idChin, {
                    ...values,
                    IdPresentaOK: idChin,
                });
    ...
    return (
        <Dialog open={open} onClose={onClose} fullWidth>
            <form onSubmit={formik.handleSubmit}>
                <DialogTitle>
                    <Typography variant="h6">Editar Paquete</Typography>
                </DialogTitle>
                <DialogContent>
                    <TextField
                        id="IdPresentaOK"
