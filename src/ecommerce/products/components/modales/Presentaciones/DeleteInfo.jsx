...
import { deleteInfo } from "../../../services/remote/delete/Presentaciones/deletepre"

const DeleteInfo = ({ open, onClose, selectedData, IdPresentaSelect, IdProductSelect, idChin }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const result = await deleteInfo(IdProductSelect, IdPresentaSelect, idChin);
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth>
      <DialogTitle>
        <Typography variant="h6">Eliminar Información</Typography>
      </DialogTitle>
      <DialogContent>
        ...
        <Typography variant="body1">
          ...
          <strong>{idChin}</strong>? Esta acción no se puede deshacer.
        </Typography>
      </DialogContent>
      <DialogActions>
        <LoadingButton
